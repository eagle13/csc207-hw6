...
public class Units
{
   ...
   */
  public static final Units POUNDS = new Units("pound", "lb.", "pounds");
  
  /** 
   * Standard unit: Ounces
   */
  public static final Units OUNCES = new Units("ounce", "oz.", "ounces");

  /**
   * Standard unit: Kilograms
   */
  public static final Units KILOGRAMS = new Units("kilogram", "kg.", "kilograms");

  /**
   * Standard unit: Grams
   */
  public static final Units GRAMS = new Units("gram", "gm.", "grams");
